...
public class Cap01Bloque01Ejercicios {
	...
	public static void main(String[] args) {
		...
		//Ejercicio6
		//Realiza un ejercicio en C para el cálculo de la cuota mensual de una hipóteca (tema tan importante hoy día)
		
		//Se deben pedir al usuario los datos de Euribor (float), Diferencial (float), Capital (float) y Número de plazos 
		//mensuales para pagar la hipoteca (int). A partir de esos datos se debe calcular y mostrar al usuario el importe 
		//de la cuota mensual.
		...
		// var_ayuda va a tener el valor de (1 + InteresMensual) elevado a numPlazosMensuales
